    ...
    angular.module('app').controller('app.views.storeRegisters', [
        ...
        function ($scope, $state, $stateParams, _thisServices, _masterService) {
                ...
                _thisServices.getById(GetstoreRegistersInputDto)
                    .then(function (result) {
                        ...
                        if (result2[0] !== undefined) {
                            ...
                            $scope.GetstoreRegistersOutputDto.uioutletId = result2[0];
                        }
                        ...
                        if (result3[0] !== undefined) {
                            ...
                            $scope.GetstoreRegistersOutputDto.uireceiptTemplateId = result3[0];
                        }
            ...
            $scope.saveAddEdit = function () {
                ...
                $scope.GetstoreRegistersOutputDto.outletId = $scope.GetstoreRegistersOutputDto.uioutletId.id;
                $scope.GetstoreRegistersOutputDto.receiptTemplateId = $scope.GetstoreRegistersOutputDto.uireceiptTemplateId.id;
