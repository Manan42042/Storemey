...
app.controller('storeCountryMastersCtrl', ['$scope', '$ngConfirm', '$state', '$stateParams', '$uibModal', 'abp.services.app.storeCountryMaster', 'cfpLoadingBar',
    function ($scope, $ngConfirm, $state, $stateParams, $uibModal, _thisServicesstoreCountryMasters, cfpLoadingBar) {
        $scope.gridOptions = [];
        $scope.storeCountryMasters = [];
        ...
        $scope.edit = function (entity) {
            ...
            //$state.go('addeditstoreCountryMaster', { 'id': entity.id, 'searchDto': $scope.SearchDto });
            $scope.SearchDto.tempID = entity.id;
            $state.go('addeditstoreCountryMaster', { SearchDto: $scope.SearchDto });
        }

        var DeletestoreCountryMasterInputDto = {
        }
        $scope.remove = function (entity) {
            //alert("remote " + JSON.stringify(entity));
            DeletestoreCountryMasterInputDto.id = entity.id;


            $ngConfirm({
                title: 'Remove record ',
                content: 'Country, name: <strong>' + entity.countryName + '</strong> <div> Are you sure you want to delete this record? </div> ',
                scope: $scope,
                buttons: {
                    Yes: {
                        text: 'YES',
                        ...
                        action: function (scope, button) {
                            _thisServicesstoreCountryMasters.delete(DeletestoreCountryMasterInputDto).then(function (result) {
        ...
        //    _thisServicesstoreCountryMasters.exportToCSV().then(function (result) {
        ...
        $scope.DropValueChange = function (item) {
            ...
            if (item === 'Export CSV') {
                ...
                var modalInstance = $uibModal.open({
                    templateUrl: '/App/Main/views/storeCountryMaster/importModal.cshtml',
                    controller: 'importstoreCountryMasterCTR',
                    backdrop: 'static'
                });
        ...
        //ui-Grid Call
        $scope.GetstoreCountryMasters = function () {
            ...
            $scope.gridOptions = {
                ...
                columnDefs: [
                    ...
                    { name: "countryName", displayName: "Country name", width: '50%', headerCellClass: $scope.highlightFilteredHeader },
                    { name: "countryCode", displayName: "Country code", width: '40%', headerCellClass: $scope.highlightFilteredHeader },
            ...
            //var apiRoute = 'api/storeCountryMaster/GetstoreCountryMasters/' + NextPage + '/' + NextPageSize;
            //var result = CRUDService.getstoreCountryMasters(apiRoute);
            ...
            //    $('.grid'),
                ...
                _thisServicesstoreCountryMasters.getAdvanceSearch($scope.SearchDto).then(function (result) {
                    if (result.data === null) {
