...
app.controller('storeTaxGroupLinkssCtrl', ['$scope', '$ngConfirm', '$state', '$stateParams', '$uibModal', 'abp.services.app.storeTaxGroupLinks', 'cfpLoadingBar',
    function ($scope, $ngConfirm, $state, $stateParams, $uibModal, _thisServicesstoreTaxGroupLinkss, cfpLoadingBar) {
        $scope.gridOptions = [];
        $scope.storeTaxGroupLinkss = [];
        ...
        $scope.edit = function (entity) {
            ...
            //$state.go('addeditstoreTaxGroupLinks', { 'id': entity.id, 'searchDto': $scope.SearchDto });
            $scope.SearchDto.tempID = entity.id;
            $state.go('addeditstoreTaxGroupLinks', { SearchDto: $scope.SearchDto });
        }

        var DeletestoreTaxGroupLinksInputDto = {
        }
        $scope.remove = function (entity) {
            //alert("remote " + JSON.stringify(entity));
            DeletestoreTaxGroupLinksInputDto.id = entity.id;
                ...
                buttons: {
                    Yes: {
                        ...
                        action: function (scope, button) {
                            _thisServicesstoreTaxGroupLinkss.delete(DeletestoreTaxGroupLinksInputDto).then(function (result) {
        ...
        //    _thisServicesstoreTaxGroupLinkss.exportToCSV().then(function (result) {
        ...
        $scope.DropValueChange = function (item) {
            ...
            if (item === 'Export CSV') {
                ...
                var modalInstance = $uibModal.open({
                    templateUrl: '/App/Main/views/storeTaxGroupLinks/importModal.cshtml',
                    controller: 'importstoreTaxGroupLinksCTR',
                    backdrop: 'static'
                });
        ...
        //ui-Grid Call
        $scope.GetstoreTaxGroupLinkss = function () {
            ...
            //var apiRoute = 'api/storeTaxGroupLinks/GetstoreTaxGroupLinkss/' + NextPage + '/' + NextPageSize;
            //var result = CRUDService.getstoreTaxGroupLinkss(apiRoute);
            ...
            //    $('.grid'),
                ...
                _thisServicesstoreTaxGroupLinkss.getAdvanceSearch($scope.SearchDto).then(function (result) {
                    if (result.data === null) {
