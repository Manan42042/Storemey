...
angular.module('app').controller('adminUpdateAllDatabaseCtrl', ['$scope', '$ngConfirm', '$state', '$stateParams', '$uibModal', 'abp.services.app.adminUpdateAllDatabase','cfpLoadingBar' ,
    function ($scope, $ngConfirm, $state, $stateParams, $uibModal, _thisServicesadminUpdateAllDatabase, cfpLoadingBar) {
        $scope.gridOptions = [];
        $scope.adminUpdateAllDatabase = [];
        ...
        $scope.edit = function (entity) {
            ...
            //$state.go('addeditadminUpdateAllDatabase', { 'id': entity.id, 'searchDto': $scope.SearchDto });
            $scope.SearchDto.tempID = entity.id;
            $state.go('addeditadminUpdateAllDatabase', { SearchDto: $scope.SearchDto });
        }

        var DeleteadminUpdateAllDatabaseInputDto = {
        }
        $scope.remove = function (entity) {
            //alert("remote " + JSON.stringify(entity));
            DeleteadminUpdateAllDatabaseInputDto.id = entity.id;
                ...
                buttons: {
                    Yes: {
                        ...
                        action: function (scope, button) {
                            _thisServicesadminUpdateAllDatabase.delete(DeleteadminUpdateAllDatabaseInputDto).then(function (result) {
        ...
        //    _thisServicesadminUpdateAllDatabase.exportToCSV().then(function (result) {
        ...
        $scope.DropValueChange = function (item) {
            ...
            if (item === 'Export CSV') {
                ...
                var modalInstance = $uibModal.open({
                    templateUrl: '/App/Main/views/adminUpdateAllDatabase/importModal.cshtml',
                    controller: 'importadminUpdateAllDatabaseCTR',
                    backdrop: 'static'
                });
        ...
        $scope.pagination = {
            ...
            pageSizeChange: function () {
                ...
                this.pageNumber = 1;
                $scope.GetadminUpdateAllDatabase();
            },
            firstPage: function () {
        ...
        //ui-Grid Call
        $scope.GetadminUpdateAllDatabase = function () {
            ...
            $scope.gridOptions = {
                ...
                columnDefs: [
                    ...
                    { name: "query", title: "Query", width: '90%', headerCellClass: $scope.highlightFilteredHeader },
            ...
            //var apiRoute = 'api/adminUpdateAllDatabase/GetadminUpdateAllDatabase/' + NextPage + '/' + NextPageSize;
            //var result = CRUDService.getadminUpdateAllDatabase(apiRoute);
            ...
            cfpLoadingBar.start();
                ...
                _thisServicesadminUpdateAllDatabase.getAdvanceSearch($scope.SearchDto).then(function (result) {
                    if (result.data === null) {
