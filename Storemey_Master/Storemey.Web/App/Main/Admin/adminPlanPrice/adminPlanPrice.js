...
angular.module('app').controller('adminPlanPriceCtrl', ['$scope', '$ngConfirm', '$state', '$stateParams', '$uibModal', 'abp.services.app.masterPlanPrices','cfpLoadingBar', 
    function ($scope, $ngConfirm, $state, $stateParams, $uibModal, _thisServicesadminPlanPrice, cfpLoadingBar) {
        $scope.gridOptions = [];
        ...
        $scope.GetadminPlanPrice = function () {
            ...
            $scope.gridOptions = {
                ...
                columnDefs: [
                    { name: "planName", title: "Plan name", width: '50%', headerCellClass: $scope.highlightFilteredHeader },
