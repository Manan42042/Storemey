...
angular.module('app').controller('adminPlanServicesCtrl', ['$scope', '$ngConfirm', '$state', '$stateParams', '$uibModal', 'abp.services.app.masterPlanServices','cfpLoadingBar' ,
    function ($scope, $ngConfirm, $state, $stateParams, $uibModal, _thisServicesadminPlanServices, cfpLoadingBar) {
        $scope.gridOptions = [];
        $scope.adminPlanServices = [];
        ...
        $scope.edit = function (entity) {
            ...
            //$state.go('addeditadminPlanServices', { 'id': entity.id, 'searchDto': $scope.SearchDto });
            $scope.SearchDto.tempID = entity.id;
            $state.go('addeditadminPlanServices', { SearchDto: $scope.SearchDto });
        }

        var DeleteadminPlanServicesInputDto = {
        }
        $scope.remove = function (entity) {
            //alert("remote " + JSON.stringify(entity));
            DeleteadminPlanServicesInputDto.id = entity.id;
                ...
                buttons: {
                    Yes: {
                        ...
                        action: function (scope, button) {
                            _thisServicesadminPlanServices.delete(DeleteadminPlanServicesInputDto).then(function (result) {
        ...
        //    _thisServicesadminPlanServices.exportToCSV().then(function (result) {
        ...
        $scope.DropValueChange = function (item) {
            ...
            if (item === 'Export CSV') {
                ...
                var modalInstance = $uibModal.open({
                    templateUrl: '/App/Main/views/adminPlanServices/importModal.cshtml',
                    controller: 'importadminPlanServicesCTR',
                    backdrop: 'static'
                });
        ...
        //ui-Grid Call
        $scope.GetadminPlanServices = function () {
            ...
            $scope.gridOptions = {
                ...
                columnDefs: [
                    ...
                    { name: "serviceName", title: "Service name", width: '35%', headerCellClass: $scope.highlightFilteredHeader },
                    { name: "planName", title: "Plan name", width: '40%', headerCellClass: $scope.highlightFilteredHeader },
            ...
            //var apiRoute = 'api/adminPlanServices/GetadminPlanServices/' + NextPage + '/' + NextPageSize;
            //var result = CRUDService.getadminPlanServices(apiRoute);
            ...
            //    $('.grid'),
                ...
                _thisServicesadminPlanServices.getAdvanceSearch($scope.SearchDto).then(function (result) {
                    if (result.data === null) {
