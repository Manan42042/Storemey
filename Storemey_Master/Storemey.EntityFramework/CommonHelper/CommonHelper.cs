...
namespace Storemey.EntityFramework
{
    public static class CommonEntityHelper
    {
        ...
        public static string TenancyConnectionString(bool ismainDB,string HostName)
        {
        ...
        public static async Task UpdateSQLAsync()
        {
            try
            {   
                using (var context = new SimpleTaskSystemDbContext(StoremeyConsts.tenantName))
                {
                    ...
                    String Cities54 = HostingEnvironment.ApplicationPhysicalPath + "/SQL_Query/Cities_54.txt";
                    ...
                    Cities54 = System.IO.File.ReadAllText(Cities54);
                    context.Database.ExecuteSqlCommand(Cities54);
                    Cities54 = string.Empty;
