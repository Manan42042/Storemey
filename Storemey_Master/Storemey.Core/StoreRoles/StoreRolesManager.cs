...
using Storemey.StoreRoles;
using Storemey.Authorization.Users;
using System.Data.Entity.SqlServer;

namespace Storemey.StoreRoles
{
    public class StoreRolesManager : IStoreRolesManager
    {
        private readonly IRepository<StoreRoles, Guid> _thisRpository;
        private readonly IUnitOfWorkManager _unitOfWorkManager;
        private readonly UserRegistrationManager _userRegistrationManager;

        public StoreRolesManager(
            IRepository<StoreRoles, Guid> myMasterRepository,
        ...
        public async Task<IEnumerable<StoreRoles>> ListAll()
        {
            try
            {
        ...
        public async Task<Tuple<IQueryable<StoreRoles>, int>> ListAllQueryable(string SearchText, int CurrentPage, int MaxRecords, string SortColumn, string SortDirection)
        {
            try
            {
                int recordCount = 0;
        ...
        public async Task Create(StoreRoles input)
        {
            try
            {
