...
namespace Storemey.Authorization.Users
{
    public class UserRegistrationManager : DomainService
    {
        ...
        public async Task<long> RegisterAsync2(long id, string name, string surname, string emailAddress, string userName, string plainPassword, bool isEmailConfirmed, bool isDelete = false, string phoneormobile = "")
        {
            ...
            try
            {
                ...
                datad.PhoneNumber = phoneormobile;
