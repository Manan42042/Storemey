    ...
    public class StoremeyApplicationModule : AbpModule
    {
        ...
        public override void Initialize()
        {
            ...
            Configuration.Modules.AbpAutoMapper().Configurators.Add(cfg =>
            {
                ...
                cfg.CreateMap<Storemey.MasterPlanPrices.MasterPlanPrices, GetMasterPlanPricesOutputDto>().ForMember(x => x.recordsTotal, opt => opt.Ignore());
                ...
                cfg.CreateMap<Storemey.StoreTaxGroupLinks.StoreTaxGroupLinks, GetStoreTaxGroupLinksOutputDto>().ForMember(x => x.recordsTotal, opt => opt.Ignore());
                ...
                cfg.CreateMap<Storemey.StoreProductVariants.StoreProductVariants, GetStoreProductVariantsOutputDto>().ForMember(x => x.recordsTotal, opt => opt.Ignore());
                cfg.CreateMap<Storemey.StoreProductVariantValues.StoreProductVariantValues, GetStoreProductVariantValuesOutputDto>().ForMember(x => x.recordsTotal, opt => opt.Ignore());
                cfg.CreateMap<Storemey.StoreProductPricing.StoreProductPricing, GetStoreProductPricingOutputDto>().ForMember(x => x.recordsTotal, opt => opt.Ignore());
                cfg.CreateMap<Storemey.StoreProductQuentity.StoreProductQuentity, GetStoreProductQuentityOutputDto>().ForMember(x => x.recordsTotal, opt => opt.Ignore());
                cfg.CreateMap<Storemey.StoreProductQuentityHistory.StoreProductQuentityHistory, GetStoreProductQuentityHistoryOutputDto>().ForMember(x => x.recordsTotal, opt => opt.Ignore());


                cfg.CreateMap<GetStoreProductsOutputDto, GetStoreProductsDto>().ForMember(x => x.ListProductImages , opt => opt.Ignore());
                cfg.CreateMap<GetStoreProductsOutputDto, GetStoreProductsDto>().ForMember(x => x.ListProductInventory, opt => opt.Ignore());
                cfg.CreateMap<GetStoreProductsOutputDto, GetStoreProductsDto>().ForMember(x => x.ListProductVariants, opt => opt.Ignore());
                cfg.CreateMap<GetStoreProductsOutputDto, GetStoreProductsDto>().ForMember(x => x.ListProductPricing, opt => opt.Ignore());
                cfg.CreateMap<GetStoreProductsOutputDto, GetStoreProductsDto>().ForMember(x => x.ListProductQuentity, opt => opt.Ignore());
                cfg.CreateMap<GetStoreProductsOutputDto, GetStoreProductsDto>().ForMember(x => x.ListProductQuentityHistory, opt => opt.Ignore());
                cfg.CreateMap<GetStoreProductPricingOutputDto, StoreProductPricingDto>().ForMember(x => x.OutletName, opt => opt.Ignore());
                cfg.CreateMap<GetStoreInventoryOutputDto, StoreProductInventoryDto>().ForMember(x => x.OutletName, opt => opt.Ignore());
                cfg.CreateMap<GetStoreProductQuentityOutputDto, StoreProductQuentityDto>().ForMember(x => x.OutletName, opt => opt.Ignore());
                cfg.CreateMap<GetStoreProductQuentityHistoryOutputDto, StoreProductQuentityHistoryDto>().ForMember(x => x.OutletName, opt => opt.Ignore());



                cfg.CreateMap<GetStoreProductsOutputDto, StoreProductVariantsDto>().ForMember(x => x.ListProductImages, opt => opt.Ignore());
                cfg.CreateMap<GetStoreProductsOutputDto, StoreProductVariantsDto>().ForMember(x => x.ListProductInventory, opt => opt.Ignore());
                cfg.CreateMap<GetStoreProductsOutputDto, StoreProductVariantsDto>().ForMember(x => x.ListProductPricing, opt => opt.Ignore());
                cfg.CreateMap<GetStoreProductsOutputDto, StoreProductVariantsDto>().ForMember(x => x.ListProductQuentity, opt => opt.Ignore());
                cfg.CreateMap<GetStoreProductsOutputDto, StoreProductVariantsDto>().ForMember(x => x.ListProductQuentityHistory, opt => opt.Ignore());
                
                cfg.CreateMap<GetStoreProductsOutputDto, StoreMasterVariantsDto>().ForMember(x => x.SelectedVariantValue, opt => opt.Ignore());
