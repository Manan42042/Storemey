...
app.controller('storeProductVariantValuessCtrl', ['$scope', '$ngConfirm', '$state', '$stateParams', '$uibModal', 'abp.services.app.storeProductVariantValues','cfpLoadingBar', 
    function ($scope, $ngConfirm, $state, $stateParams, $uibModal, _thisServicesstoreProductVariantValuess, cfpLoadingBar) {
        $scope.gridOptions = [];
        $scope.storeProductVariantValuess = [];
        ...
        $scope.edit = function (entity) {
            ...
            //$state.go('addeditstoreProductVariantValues', { 'id': entity.id, 'searchDto': $scope.SearchDto });
            $scope.SearchDto.tempID = entity.id;
            $state.go('addeditstoreProductVariantValues', { SearchDto: $scope.SearchDto });
        }

        var DeletestoreProductVariantValuesInputDto = {
        }
        $scope.remove = function (entity) {
            //alert("remote " + JSON.stringify(entity));
            DeletestoreProductVariantValuesInputDto.id = entity.id;


            $ngConfirm({
                title: 'Remove record ',
                content: 'Brand, name: <strong>' + entity.brandName + '</strong> <div> Are you sure you want to delete this record? </div> ',
                scope: $scope,
                buttons: {
                    Yes: {
                        text: 'YES',
                        ...
                        action: function (scope, button) {
                            _thisServicesstoreProductVariantValuess.delete(DeletestoreProductVariantValuesInputDto).then(function (result) {
        ...
        //    _thisServicesstoreProductVariantValuess.exportToCSV().then(function (result) {
        ...
        $scope.DropValueChange = function (item) {
            ...
            if (item === 'Export CSV') {
                ...
                var modalInstance = $uibModal.open({
                    templateUrl: '/App/Main/views/storeProductVariantValues/importModal.cshtml',
                    controller: 'importstoreProductVariantValuesCTR',
                    backdrop: 'static'
                });
        ...
        $scope.pagination = {
            ...
            pageSizeChange: function () {
                ...
                this.pageNumber = 1;
                $scope.GetstoreProductVariantValuess();
            },
            firstPage: function () {
        ...
        //ui-Grid Call
        $scope.GetstoreProductVariantValuess = function () {
            ...
            $scope.gridOptions = {
                ...
                columnDefs: [
                    ...
                    { name: "variantName", displayName: "Variant Name", width: '30%', headerCellClass: $scope.highlightFilteredHeader },
                    { name: "variantValue", displayName: "Variant Value", width: '60%', headerCellClass: $scope.highlightFilteredHeader },
            ...
            //var apiRoute = 'api/storeProductVariantValues/GetstoreProductVariantValuess/' + NextPage + '/' + NextPageSize;
            //var result = CRUDService.getstoreProductVariantValuess(apiRoute);
            ...
            cfpLoadingBar.start();
                ...
                _thisServicesstoreProductVariantValuess.getAdvanceSearch($scope.SearchDto).then(function (result) {
                    if (result.data === null) {
