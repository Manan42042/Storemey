    ...
    angular.module('app').controller(controllerId, [
        ...
        function ($rootScope, $state, appSession) {
            ...
            vm.menuItems = [
                ...
                createMenuItem(1000, "Store home", "", "Home", "javascript:void()", true, [
                ...
                createMenuItem(1002, "Customers and giftcards", "", "", "javascript:void()", true, [
                ...
                createMenuItem(1000, "Products and product settings", "", "Products", "javascript:void()", true, [
                    createMenuItem(2006, "Products", "Pages.storeProducts", "storeProducts", "storeProducts", false),
                    createMenuItem(2020, "Suppliers", "Pages.storeSuppliers", "storeSuppliers", "storeSuppliers", false),

                    createMenuItem(2007, "Products Adjustment", "", "icon-product", "javascript:void()", true, [
                        ...
                        createMenuItem(105, "Variant", "Pages.storeProductVariants", "storeProductVariants", "storeProductVariants", false),
                        createMenuItem(106, "Variant value", "Pages.storeProductVariantValues", "storeProductVariantValues", "storeProductVariantValues", false),
                    ]),
                ...
                createMenuItem(1005, "Store features and settings", "", "", "", true, [
                    createMenuItem(2021, "Warehouses", "Pages.Warehouses", "storeWarehouses", "storeWarehouses", false),
                    createMenuItem(2022, "Outlets", "Pages.Outlets", "storeOutlets", "storeOutlets", false),
                    createMenuItem(2023, "Registers", "Pages.Registers", "storeRegisters", "storeRegisters", false),
                    createMenuItem(2024, "Users", "Pages.storeUsers", "Users", "storeUsers", false),

                    createMenuItem(2009, "Store Adjustment", "", "icon-system-setup", "javascript:void()", true, [
                    ...
                    createMenuItem(2010, "Primary Data", "", "icon-basic-setup", "javascript:void()", true, [
                ...
                createMenuItem(1006, "Store Ecommerce", "", "", "javascript:void()", true, [
