        ...
        $scope.GetstoreTaxGroupss = function () {
            ...
            $scope.gridOptions = {
                ...
                columnDefs: [
                    ...
                    { name: "taxCommaseparated", displayName: "Tax list", width: '30%', headerCellClass: $scope.highlightFilteredHeader },
                    { name: "rate", displayName: "Group rate (%)", width: '30%', headerCellClass: $scope.highlightFilteredHeader },
