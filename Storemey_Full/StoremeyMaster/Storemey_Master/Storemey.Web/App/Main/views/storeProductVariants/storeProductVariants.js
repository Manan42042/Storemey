...
app.controller('storeProductVariantssCtrl', ['$scope', '$ngConfirm', '$state', '$stateParams', '$uibModal', 'abp.services.app.storeProductVariants','cfpLoadingBar', 
    function ($scope, $ngConfirm, $state, $stateParams, $uibModal, _thisServicesstoreProductVariantss, cfpLoadingBar) {
        $scope.gridOptions = [];
        $scope.storeProductVariantss = [];
        ...
        $scope.edit = function (entity) {
            ...
            //$state.go('addeditstoreProductVariants', { 'id': entity.id, 'searchDto': $scope.SearchDto });
            $scope.SearchDto.tempID = entity.id;
            $state.go('addeditstoreProductVariants', { SearchDto: $scope.SearchDto });
        }

        var DeletestoreProductVariantsInputDto = {
        }
        $scope.remove = function (entity) {
            //alert("remote " + JSON.stringify(entity));
            DeletestoreProductVariantsInputDto.id = entity.id;


            $ngConfirm({
                title: 'Remove record ',
                content: 'variant, name: <strong>' + entity.variantName + '</strong> <div> Are you sure you want to delete this record? </div> ',
                scope: $scope,
                buttons: {
                    Yes: {
                        text: 'YES',
                        ...
                        action: function (scope, button) {
                            _thisServicesstoreProductVariantss.delete(DeletestoreProductVariantsInputDto).then(function (result) {
        ...
        //    _thisServicesstoreProductVariantss.exportToCSV().then(function (result) {
        ...
        $scope.DropValueChange = function (item) {
            ...
            if (item === 'Export CSV') {
                ...
                var modalInstance = $uibModal.open({
                    templateUrl: '/App/Main/views/storeProductVariants/importModal.cshtml',
                    controller: 'importstoreProductVariantsCTR',
                    backdrop: 'static'
                });
        ...
        $scope.pagination = {
            ...
            pageSizeChange: function () {
                ...
                this.pageNumber = 1;
                $scope.GetstoreProductVariantss();
            },
            firstPage: function () {
        ...
        //ui-Grid Call
        $scope.GetstoreProductVariantss = function () {
            ...
            $scope.gridOptions = {
                ...
                columnDefs: [
                    ...
                    { name: "variantName", displayName: "variant Name", width: '90%', headerCellClass: $scope.highlightFilteredHeader },
                    {
                        name: 'Commands',
                        enableFiltering: false,
                        enableSorting: false,
            ...
            //var apiRoute = 'api/storeProductVariants/GetstoreProductVariantss/' + NextPage + '/' + NextPageSize;
            //var result = CRUDService.getstoreProductVariantss(apiRoute);
            ...
            cfpLoadingBar.start();
                ...
                _thisServicesstoreProductVariantss.getAdvanceSearch($scope.SearchDto).then(function (result) {
                    if (result.data === null) {
