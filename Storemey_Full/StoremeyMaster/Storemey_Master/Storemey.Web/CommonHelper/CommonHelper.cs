...
namespace Storemey.Web.CommonHelper
{
    public static class CommonWebHelper
    {
        ...
        *  the base EF class name */
        ...
        public static string ResizeImage(Image image, int x1, int y1, int width, int height,string filename)
        {
            ...
            using (var graphics = Graphics.FromImage(destImage))
            {
                ...
                using (var wrapMode = new ImageAttributes())
                {
                    ...
                    graphics.DrawImage(image, destRect, x1, y1, width, height, GraphicsUnit.Pixel, wrapMode);
                }
            }
            ...
            destImage.Save(path + Path.GetFileName(newfilename));


            return "/TempImage/"+ Path.GetFileName(newfilename);
        }
        public static Bitmap FixedSize(Bitmap imgPhoto, int x1, int y1, int Width, int Height)
        {
