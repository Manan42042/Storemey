...
namespace Storemey.Web.Controllers
{
    ...
    public class HomeController : StoremeyControllerBase
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel loginModel, string returnUrl = "", string returnUrlHash = "")
        {
            try
            {
                ...
                try
                {
                    ...
                    //string oldvalue = StoremeyConsts.tenantName;
                    //StoremeyConsts.tenantName = string.Empty;
                    StoremeyConsts.tenantPassword = loginModel.Password;// loginResult.User.Password ;
                    StoremeyConsts.tenantName = loginModel.TenancyName;
                    StoremeyConsts.tenantUserName = loginResult.User.UserName;
                    StoremeyConsts.tenanEmail = loginResult.User.EmailAddress;
                ...
                if (result)
                {
                    StoremeyConsts.BackendErrorString = "store '" + loginModel.TenancyName + "' is expired! please upgrade your account";
                    return Content(StoremeyConsts.BackendErrorString);
                ...
                StoremeyConsts.loginFirstName = loginResult.User.Name;
                StoremeyConsts.loginLastName = loginResult.User.Surname;
                StoremeyConsts.loginUserName = loginResult.User.UserName;
        ...
        public async Task CreateNewRegisterAsync(RegisterTenantViewModel RegiterModel, string returnUrl = "", string returnUrlHash = "", string previousTenant = "")
        {
            ...
            await Storemey.EntityFramework.CommonEntityHelper.UpdateSQLAsync();
            await _tenantAppService.AddstoreUserDatabase(CTD);
        ...
        private async Task<AbpLoginResult<Tenant, User>> GetLoginResultAsync(string usernameOrEmailAddress, string password, string tenancyName)
        {
            ...
            switch (loginResult.Result)
            {
                ...
                default:
                    {
                        StoremeyConsts.BackendErrorString = "Invalid tenancyname or username or password.please try again.";
