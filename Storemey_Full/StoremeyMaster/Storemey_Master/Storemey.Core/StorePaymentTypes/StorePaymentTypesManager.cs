...
namespace Storemey.StorePaymentTypes
{
    public class StorePaymentTypesManager : IStorePaymentTypesManager
    {
        ...
        public async Task<Tuple<IQueryable<StorePaymentTypes>, int>> ListAllQueryable(string SearchText, int CurrentPage, int MaxRecords, string SortColumn, string SortDirection)
