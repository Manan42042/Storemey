...
namespace Storemey.StoreTimeZones
{
    public class StoreTimeZonesManager : IStoreTimeZonesManager
    {
        ...
        public async Task<Tuple<IQueryable<StoreTimeZones>,int>> ListAllQueryable(string SearchText, int CurrentPage, int MaxRecords, string SortColumn, string SortDirection)
        {
            try
            {
                int recordCount = 0;
