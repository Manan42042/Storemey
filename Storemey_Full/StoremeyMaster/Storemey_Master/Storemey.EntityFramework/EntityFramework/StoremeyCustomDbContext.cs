...
namespace Storemey.EntityFramework
{
    ...
    public class SimpleTaskSystemDbContext : AbpDbContext
    {
        ...
        public virtual IDbSet<Storemey.StoreTaxGroupLinks.StoreTaxGroupLinks> StoreTaxGroupLinks { get; set; } //2
        ...
        public virtual IDbSet<Storemey.StoreProductVariants.StoreProductVariants> StoreProductVariants { get; set; } //14
        public virtual IDbSet<Storemey.StoreProductVariantValues.StoreProductVariantValues> StoreProductVariantValues { get; set; } //14
        public virtual IDbSet<Storemey.StoreProductPricing.StoreProductPricing> StoreProductPricing { get; set; } //14
        public virtual IDbSet<Storemey.StoreProductQuentity.StoreProductQuentity> StoreProductQuentity { get; set; } //14
        public virtual IDbSet<Storemey.StoreProductQuentityHistory.StoreProductQuentityHistory> StoreProductQuentityHistory { get; set; } //14
        public virtual IDbSet<Storemey.StoreProductVariantsLinks.StoreProductVariantsLinks> StoreProductVariantsLinks { get; set; } //14
        ...
        public SimpleTaskSystemDbContext(string nameOrConnectionString)
            : base(StoremeyConsts.tenantName == "" ? nameOrConnectionString : CommonEntityHelper.TenancyConnectionString(StoremeyConsts.isMaindatabse, StoremeyConsts.tenantName))
        {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Storemey.StoreTaxGroupLinks.StoreTaxGroupLinks>().ToTable("StoreTaxGroupLinks");
            ...
            modelBuilder.Entity<Storemey.StoreProductVariants.StoreProductVariants>().ToTable("StoreProductVariants");
            modelBuilder.Entity<Storemey.StoreProductVariantValues.StoreProductVariantValues>().ToTable("StoreProductVariantValues");
            modelBuilder.Entity<Storemey.StoreProductPricing.StoreProductPricing>().ToTable("StoreProductPricing");
            modelBuilder.Entity<Storemey.StoreProductQuentity.StoreProductQuentity>().ToTable("StoreProductQuentity");
            modelBuilder.Entity<Storemey.StoreProductVariantsLinks.StoreProductVariantsLinks>().ToTable("StoreProductVariantsLinks");
