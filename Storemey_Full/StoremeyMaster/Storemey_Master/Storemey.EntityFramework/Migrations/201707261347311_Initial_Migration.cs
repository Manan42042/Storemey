namespace Storemey.Migrations
{
    ...
    public partial class Initial_Migration : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                {
                    ...
                    Name = c.String(nullable: true, maxLength: 32),
                    Surname = c.String(nullable: true, maxLength: 32),
                    Password = c.String(nullable: true, maxLength: 128),
     ...
     c => new
     {
         ...
         is_currently_dst = c.Boolean(defaultValue: false),
         ...
         Note = c.String(),
            ...
            CreateTable("dbo.StorePaymentTypes",
                          c => new
                          {
                              ...
                              IsPOSPaymentType = c.Boolean(defaultValue: false),
                              IsEcommarcePaymentType = c.Boolean(defaultValue: false),
            ...
            CreateTable("dbo.StoreReceiptTemplates",
                        c => new
                        {
                            Id = c.Long(nullable: false, identity: true),
                            Name = c.String(true, 200),
                            TemplateType = c.String(true, 200),
            ...
            CreateTable("dbo.storeTaxGroupLinks",
               c => new
               {
                   Id = c.Long(nullable: false, identity: true),
                   TaxId = c.Int(),
            ...
            CreateTable("dbo.StoreProducts",
                    c => new
                    {
                        ...
                        VariantId1 = c.Decimal(nullable: false, defaultValue: 0),
                        VariantValueId1 = c.Decimal(nullable: false, defaultValue: 0),
                        VariantId2 = c.Decimal(nullable: false, defaultValue: 0),
                        VariantValueId2 = c.Decimal(nullable: false, defaultValue: 0),
                        VariantId3 = c.Decimal(nullable: false, defaultValue: 0),
                        VariantValueId3 = c.Decimal(nullable: false, defaultValue: 0),
            ...
            CreateTable("dbo.StoreNotifications",
                  c => new
                  {
                      Id = c.Long(nullable: false, identity: true),

                      Text = c.String(true, 500),
                      FromId = c.Long(nullable: true, defaultValue: 0),
                      ToId = c.Long(nullable: true, defaultValue: 0),
                      IsSent = c.Boolean(nullable: false, defaultValue: true),
                      IsReceive = c.Boolean(nullable: false, defaultValue: true),
                      NotifyDatetime = c.DateTime(defaultValueSql: "GETUTCDATE()"),
                      IsRead = c.Boolean(nullable: false, defaultValue: true),
            ...
            CreateTable("dbo.StoreProductVariants",
                  c => new
                  {
                      Id = c.Long(nullable: false, identity: true),

                      VariantName = c.String(true, 5000),
            ...
            CreateTable("dbo.StoreProductVariantValues",
                c => new
                {
                    Id = c.Long(nullable: false, identity: true),
                    VariantId = c.Long(nullable: true),
                    VariantValue = c.String(true, 5000),
            ...
            CreateTable("dbo.StoreProductPricing",
                c => new
                {
                    Id = c.Long(nullable: false, identity: true),
                    ProductId = c.Long(nullable: true),
                    OutletId = c.Long(nullable: true),
                    Price = c.Decimal(nullable: false, defaultValue: 0),
                    MarkUp = c.Decimal(nullable: false, defaultValue: 0),
                    PriceExcludingTax = c.Decimal(nullable: false, defaultValue: 0),
                    TaxId = c.Long(nullable: true, defaultValue: 0),
            ...
            CreateTable("dbo.StoreProductQuentity",
                c => new
                {
                    Id = c.Long(nullable: false, identity: true),
                    ProductId = c.Long(nullable: true),
                    OutletId = c.Long(nullable: true),
                    Quentity = c.Long(nullable: true),
            ...
            CreateTable("dbo.StoreProductVariantsLinks",
                c => new
                {
                    Id = c.Long(nullable: false, identity: true),
                    ProductId = c.Long(nullable: true),
                    VariantId = c.Long(nullable: true),
                    VariantValueId = c.Long(nullable: true),
            ...
            CreateTable("dbo.StoreProductQuentityHistory",
                     c => new
                     {
                         Id = c.Long(nullable: false, identity: true),
                         ProductId = c.Long(nullable: true),
                         OutletId = c.Long(nullable: true),
                         OldValue = c.Long(nullable: true),
                         NewValue = c.Long(nullable: true),
                         Margin = c.Long(nullable: true),
                         FinalQuentity = c.Long(nullable: true),
                         ActionDetail = c.String(true, 5000),
                         ActionById = c.Long(true),
                         ActionByName = c.String(true, 5000),
                         ActionDateTime = c.DateTime(defaultValueSql: "GETUTCDATE()"),
            ...
            CreateStoredProcedure("dbo.sp_insert_city_from_state", "INSERT INTO [dbo].[StoreCityMaster] ([CountryId] ,[StateId] ,[CityName])          select CountryId, id, StateName from[dbo].[StoreStateMaster] where Id not in (Select Stateid from[dbo].[StoreCityMaster]);");
        }
