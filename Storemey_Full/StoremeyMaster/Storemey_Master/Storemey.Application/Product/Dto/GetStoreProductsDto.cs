...
namespace Storemey.ProductService.Dto
{
    public class GetStoreProductsDto
    {
        ...
        public virtual StoreProductVariantsDto DefaultProductVariants { get; set; }
        ...
        public virtual List<StoreProductCategoryLinksDto> ListCategory { get; set; }
        public virtual List<StoreProductBrandLinksDto> ListBrands { get; set; }
        public virtual List<StoreProductTagLinksDto> ListTags { get; set; }
        public virtual List<StoreProductSeasonLinksDto> ListSeason { get; set; }
        public virtual List<StoreProductVariantsLinksDto> SelectedVariant { get; set; }
