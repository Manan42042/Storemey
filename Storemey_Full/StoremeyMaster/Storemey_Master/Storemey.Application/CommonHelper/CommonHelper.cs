...
namespace Storemey.Application
{
    public static class CommonEntityHelper
    {
        ...
        public static void DeleteOldProducts(string filePath, string imageoldname)
        {
        ...
        public static string Savenewimage(string base64String, string filePath, string imagename, string imageoldname)
        {
            //if (!string.IsNullOrEmpty(imageoldname))
            //{
            //    try
            ...
            //Bitmap bitmapimage = (Bitmap)Image.FromFile(HostingEnvironment.ApplicationPhysicalPath +  "/" + base64String);
            Bitmap bitmapimage = GetCopyImage(HostingEnvironment.ApplicationPhysicalPath + "/" + base64String);
            ...
            return filePath.Replace(HostingEnvironment.ApplicationPhysicalPath , "") + imagename + "640@640.jpg";
        }
