using net.authorize.StoremeyPayments.MobileInappTransactions;
using net.authorize.StoremeyPayments.PaymentTransactions;
using System;
using net.authorize.StoremeyPayments.CustomerProfiles;
...
namespace net.authorize.StoremeyPayments
{
    //===============================================================================================
    //
    //  NOTE:  If you add a new StoremeyPayments update the following methods here:
    //
    //              ShowMethods()   -  Add the method name
    //              RunMethod(String methodName)   -   Update the switch statement to run the method
    //
    //===============================================================================================
    class StoremeyPaymentsCode
    {
        ...
        {
            Console.WriteLine("Usage : StoremeyPaymentsCode [CodeStoremeyPaymentsName]");
            Console.WriteLine("");
            Console.WriteLine("Run with no parameter to select a method.  Otherwise pass a method name.");
            Console.WriteLine("");
            Console.WriteLine("Code StoremeyPayments Names: ");
            ShowMethods();
            Console.WriteLine("Code StoremeyPayments Names: ");
        ...
        private static void SelectMethod()
        {
            ...
            ShowMethods();
            Console.WriteLine("");
            Console.Write("Type a StoremeyPayments name & then press <Return> : ");
        ...
        private static void RunMethod(String methodName)
        {
            ...
            //Update TransactionID for which you want to run the StoremeyPayments code
            const string transactionId = "2249735976";

            //Update PayerID for which you want to run the StoremeyPayments code
