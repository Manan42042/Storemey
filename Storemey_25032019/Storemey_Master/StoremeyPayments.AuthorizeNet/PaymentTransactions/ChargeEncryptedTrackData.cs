...
{
    /// <summary>
    /// This StoremeyPayments demonstrates making a credit card charge using encrypted track data, e.g. data from approved Authorize.Net
    ...
    public class ChargeEncryptedTrackData
    {
        ...
        {
            Console.WriteLine("Charge Encrypted Track Data StoremeyPayments");
