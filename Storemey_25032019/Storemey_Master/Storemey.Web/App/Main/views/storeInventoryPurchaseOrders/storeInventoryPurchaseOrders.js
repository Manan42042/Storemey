...
app.controller('storeInventoryPurchaseOrderssCtrl', ['$scope', '$ngConfirm', '$state', '$stateParams', '$uibModal', 'abp.services.app.storeInventoryPurchaseOrders','cfpLoadingBar', 
    function ($scope, $ngConfirm, $state, $stateParams, $uibModal, _thisServicesstoreInventoryPurchaseOrderss, cfpLoadingBar) {
        $scope.gridOptions = [];
        $scope.storeInventoryPurchaseOrderss = [];
        ...
        $scope.edit = function (entity) {
            ...
            //$state.go('addeditstoreInventoryPurchaseOrders', { 'id': entity.id, 'searchDto': $scope.SearchDto });
            $scope.SearchDto.tempID = entity.id;
            $state.go('addeditstoreInventoryPurchaseOrders', { SearchDto: $scope.SearchDto });
        }

        var DeletestoreInventoryPurchaseOrdersInputDto = {
        }
        $scope.remove = function (entity) {
            //alert("remote " + JSON.stringify(entity));
            DeletestoreInventoryPurchaseOrdersInputDto.id = entity.id;
                ...
                buttons: {
                    Yes: {
                        ...
                        action: function (scope, button) {
                            _thisServicesstoreInventoryPurchaseOrderss.delete(DeletestoreInventoryPurchaseOrdersInputDto).then(function (result) {
        ...
        //    _thisServicesstoreInventoryPurchaseOrderss.exportToCSV().then(function (result) {
        ...
        $scope.DropValueChange = function (item) {
            ...
            if (item === 'Export CSV') {
                ...
                var modalInstance = $uibModal.open({
                    templateUrl: '/App/Main/views/storeInventoryPurchaseOrders/importModal.cshtml',
                    controller: 'importstoreInventoryPurchaseOrdersCTR',
                    backdrop: 'static'
                });
        ...
        $scope.pagination = {
            ...
            pageSizeChange: function () {
                ...
                this.pageNumber = 1;
                $scope.GetstoreInventoryPurchaseOrderss();
            },
            firstPage: function () {
        ...
        //ui-Grid Call
        $scope.GetstoreInventoryPurchaseOrderss = function () {
            ...
            $scope.gridOptions = {
                ...
                columnDefs: [
                    ...
                    { name: "brandName", displayName: "Brand Name", width: '90%', headerCellClass: $scope.highlightFilteredHeader },
            ...
            //var apiRoute = 'api/storeInventoryPurchaseOrders/GetstoreInventoryPurchaseOrderss/' + NextPage + '/' + NextPageSize;
            //var result = CRUDService.getstoreInventoryPurchaseOrderss(apiRoute);
            ...
            cfpLoadingBar.start();
                ...
                _thisServicesstoreInventoryPurchaseOrderss.getAdvanceSearch($scope.SearchDto).then(function (result) {
                    if (result.data === null) {
