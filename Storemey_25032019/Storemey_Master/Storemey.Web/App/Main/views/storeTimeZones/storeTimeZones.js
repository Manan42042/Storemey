...
app.controller('storeTimeZonesCtrl', ['$scope', '$ngConfirm', '$state', '$stateParams', '$uibModal', 'abp.services.app.storeTimeZones', 'cfpLoadingBar',
    function ($scope, $ngConfirm, $state, $stateParams, $uibModal, _thisServicesstoreTimeZones, cfpLoadingBar) {
        $scope.gridOptions = [];
        $scope.storeTimeZones = [];
        ...
        $scope.edit = function (entity) {
            ...
            //$state.go('addeditstoreTimeZones', { 'id': entity.id, 'searchDto': $scope.SearchDto });
            $scope.SearchDto.tempID = entity.id;
            $state.go('addeditstoreTimeZones', { SearchDto: $scope.SearchDto });
        }

        var DeletestoreTimeZonesInputDto = {
        }
        $scope.remove = function (entity) {
            //alert("remote " + JSON.stringify(entity));
            DeletestoreTimeZonesInputDto.id = entity.id;
                ...
                buttons: {
                    Yes: {
                        ...
                        action: function (scope, button) {
                            _thisServicesstoreTimeZones.delete(DeletestoreTimeZonesInputDto).then(function (result) {
        ...
        //    _thisServicesstoreTimeZones.exportToCSV().then(function (result) {
        ...
        $scope.DropValueChange = function (item) {
            ...
            if (item === 'Export CSV') {
                ...
                var modalInstance = $uibModal.open({
                    templateUrl: '/App/Main/views/storeTimeZones/importModal.cshtml',
                    controller: 'importstoreTimeZonesCTR',
                    backdrop: 'static'
                });
        ...
        //ui-Grid Call
        $scope.GetstoreTimeZones = function () {
            ...
            $scope.gridOptions = {
                ...
                columnDefs: [
                    ...
                    { name: "name", displayName: "Name", width: '40%', headerCellClass: $scope.highlightFilteredHeader },
                    { name: "current_utc_offset", enableSorting: false, displayName: "Current offset", width: '20%', headerCellClass: $scope.highlightFilteredHeader },
                    { name: "is_currently_dst", displayName: "Is daylightsaving", width: '15%', headerCellClass: $scope.highlightFilteredHeader },
                    { name: "isSelected", displayName: "Is selected", width: '15%', headerCellClass: $scope.highlightFilteredHeader },
            ...
            //var apiRoute = 'api/storeTimeZones/GetstoreTimeZones/' + NextPage + '/' + NextPageSize;
            //var result = CRUDService.getstoreTimeZones(apiRoute);
            ...
            cfpLoadingBar.start();
                ...
                _thisServicesstoreTimeZones.getAdvanceSearch($scope.SearchDto).then(function (result) {
                    if (result.data === null) {
