...
app.controller('PlansCtrl', ['$scope', '$state', '$stateParams', '$ngConfirm', '$uibModal', 'abp.services.app.masterPlans', '$http', '$q', 'uiGridExporterService', 'uiGridExporterConstants','cfpLoadingBar',
    function ($scope, $state, $stateParams, $ngConfirm, $uibModal, _thisServices, $http, $q, uiGridExporterService, uiGridExporterConstants, cfpLoadingBar) {
        $scope.gridOptions = [];
        $scope.Plans = [];
        ...
        $scope.remove = function (entity) {
            ...
            $ngConfirm({
                title: 'Remove record ',
                content: 'Plan name: <strong>' + entity.planName + '</strong> <div> Are you sure you want to delete this record? </div> ',
                scope: $scope,
                buttons: {
                    Yes: {
                        text: 'YES',
        ...
        $scope.DropValueChange = function (item) {
            ...
            if (item === 'Export CSV') {
                ...
                var modalInstance = $uibModal.open({
                    ...
                    controller: 'importmasterPlansCTR as vm',
                    backdrop: 'static'
                });
