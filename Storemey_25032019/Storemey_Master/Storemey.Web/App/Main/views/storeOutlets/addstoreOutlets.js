(function () {
    angular.module('app').controller('app.views.storeOutlets', [
        ...
        function ($scope, $state, $stateParams, _thisServices, _masterService) {
            ...
            $scope.$watch("GetstoreOutletsOutputDto.countryId", function (newValue, oldValue) {
                    ...
                    _masterService.listAllStates(newValue.id)
                        .then(function (result) {
                            ...
                            if (result3[0] !== undefined) {
                                ...
                                $scope.GetstoreOutletsOutputDto.stateId = result3[0];
                            }
                        });
                }
            });

            $scope.$watch("GetstoreOutletsOutputDto.stateId", function (newValue, oldValue) {
                ...
                if (newValue !== undefined && newValue !== "") {
                    ...
                    _masterService.listAllCities(newValue.id)
                        .then(function (result) {
                            ...
                            if (result3[0] !== undefined) {
                                console.log(result3[0]);
                                $scope.GetstoreOutletsOutputDto.cityId = result3[0];
                            }
            ...
            $scope.$watch("GetstoreOutletsOutputDto.cityId", function (newValue, oldValue) {
                ...
                _thisServices.getById(GetstoreOutletsInputDto)
                    .then(function (result) {
                        ...
                        if (result2[0] !== undefined) {
                            ...
                            $scope.GetstoreOutletsOutputDto.countryId = result2[0];
                        }
                        ...
                        if (result3[0] !== undefined) {
                            console.log(result3[0]);
                            $scope.GetstoreOutletsOutputDto.warehouseId = result3[0];
                        }
                        ...
                        if (result4[0] !== undefined) {
                            ...
                            $scope.GetstoreOutletsOutputDto.time = result4[0];
                        }
                    });
            }
            //if ($scope.Id !== 0) {
            ...
            $scope.saveAddEdit = function () {
                ...
                $scope.GetstoreOutletsOutputDto.country = $scope.GetstoreOutletsOutputDto.countryId.countryName;
                $scope.GetstoreOutletsOutputDto.countryId = $scope.GetstoreOutletsOutputDto.countryId.id;
                $scope.GetstoreOutletsOutputDto.state = $scope.GetstoreOutletsOutputDto.stateId.stateName;
                $scope.GetstoreOutletsOutputDto.stateId = $scope.GetstoreOutletsOutputDto.stateId.id;
                $scope.GetstoreOutletsOutputDto.city = $scope.GetstoreOutletsOutputDto.cityId.cityName;
                $scope.GetstoreOutletsOutputDto.cityId = $scope.GetstoreOutletsOutputDto.cityId.id;
                $scope.GetstoreOutletsOutputDto.warehouseId = $scope.GetstoreOutletsOutputDto.warehouseId.id;
                $scope.GetstoreOutletsOutputDto.timeZone = $scope.GetstoreOutletsOutputDto.time.name;
