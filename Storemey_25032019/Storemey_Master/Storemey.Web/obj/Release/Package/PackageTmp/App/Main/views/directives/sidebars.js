 ...
 */
angular.module('app').directive('sidebar', ['$document', '$rootScope',
            ...
            elem.on(eventObject, 'nav a', function (e) {
                ...
                if (!_this.parent().hasClass('hover') && !_this.closest("ul").hasClass("sub-menu")) {
                    ...
                    if (_this.next().is('ul')) {
                        ...
                        //alert(itemTop + _this.parent().outerHeight());
                        ul.appendTo(wrap).css({
                            top: $(this).offset().top + _this.parent().outerHeight(),// itemTop + _this.parent().outerHeight(),
                            position: isSidebarFixed() && !isBoxedPage() ? 'fixed' : 'absolute',
                        });
