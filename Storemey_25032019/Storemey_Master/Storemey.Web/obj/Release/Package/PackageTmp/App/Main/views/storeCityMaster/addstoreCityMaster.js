(function () {
    angular.module('app').controller('app.views.storeCityMaster', [
        ...
        function ($scope, $state, $stateParams, _thisServices, _masterService) {
            ...
            $scope.$watch("GetstoreCityMasterOutputDto.countryId", function (newValue, oldValue) {
                    ...
                    _masterService.listAllStates(newValue.id)
                        .then(function (result) {
                            ...
                            if (result3[0] !== undefined) {
                                ...
                                $scope.GetstoreCityMasterOutputDto.stateId = result3[0];
                            }
                ...
                _thisServices.getById(GetstoreCityMasterInputDto)
                    .then(function (result) {
                        ...
                        if (result2[0] !== undefined) {
                            ...
                            $scope.GetstoreCityMasterOutputDto.countryId = result2[0];
                        }
                    });
            }
            //if ($scope.Id !== 0) {
            ...
            $scope.saveAddEdit = function () {
                ...
                $scope.GetstoreCityMasterOutputDto.countryId = $scope.GetstoreCityMasterOutputDto.countryId.id;
                $scope.GetstoreCityMasterOutputDto.stateId = $scope.GetstoreCityMasterOutputDto.stateId.id;
