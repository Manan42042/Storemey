...
angular.module('app').controller('adminBugTrackerCommentsCtrl', ['$scope', '$ngConfirm', '$state', '$stateParams', '$uibModal', 'abp.services.app.adminBugTrackerComments','cfpLoadingBar' ,
    function ($scope, $ngConfirm, $state, $stateParams, $uibModal, _thisServicesadminBugTrackerComments, cfpLoadingBar) {
        $scope.gridOptions = [];
        $scope.adminBugTrackerComments = [];
        ...
        $scope.edit = function (entity) {
            ...
            //$state.go('addeditadminBugTrackerComments', { 'id': entity.id, 'searchDto': $scope.SearchDto });
            $scope.SearchDto.tempID = entity.id;
            $state.go('addeditadminBugTrackerComments', { SearchDto: $scope.SearchDto });
        }

        var DeleteadminBugTrackerCommentsInputDto = {
        }
        $scope.remove = function (entity) {
            //alert("remote " + JSON.stringify(entity));
            DeleteadminBugTrackerCommentsInputDto.id = entity.id;
                ...
                buttons: {
                    Yes: {
                        ...
                        action: function (scope, button) {
                            _thisServicesadminBugTrackerComments.delete(DeleteadminBugTrackerCommentsInputDto).then(function (result) {
        ...
        //    _thisServicesadminBugTrackerComments.exportToCSV().then(function (result) {
        ...
        $scope.DropValueChange = function (item) {
            ...
            if (item === 'Export CSV') {
                ...
                var modalInstance = $uibModal.open({
                    templateUrl: '/App/Main/views/adminBugTrackerComments/importModal.cshtml',
                    controller: 'importadminBugTrackerCommentsCTR',
                    backdrop: 'static'
                });
        ...
        $scope.pagination = {
            ...
            pageSizeChange: function () {
                ...
                this.pageNumber = 1;
                $scope.GetadminBugTrackerComments();
            },
            firstPage: function () {
        ...
        //ui-Grid Call
        $scope.GetadminBugTrackerComments = function () {
            ...
            //var apiRoute = 'api/adminBugTrackerComments/GetadminBugTrackerComments/' + NextPage + '/' + NextPageSize;
            //var result = CRUDService.getadminBugTrackerComments(apiRoute);
            ...
            _thisServicesadminBugTrackerComments.getAdvanceSearch($scope.SearchDto).then(function (result) {
                if (result.data === null) {
