...
angular.module('app').controller('adminStoreSchedulerCtrl', ['$scope', '$ngConfirm', '$state', '$stateParams', '$uibModal', 'abp.services.app.adminStoreScheduler', 'cfpLoadingBar',
    function ($scope, $ngConfirm, $state, $stateParams, $uibModal, _thisServicesadminStoreScheduler, cfpLoadingBar) {
        $scope.gridOptions = [];
        $scope.adminStoreScheduler = [];
        ...
        $scope.edit = function (entity) {
            ...
            //$state.go('addeditadminStoreScheduler', { 'id': entity.id, 'searchDto': $scope.SearchDto });
            $scope.SearchDto.tempID = entity.id;
            $state.go('addeditadminStoreScheduler', { SearchDto: $scope.SearchDto });
        }

        var DeleteadminStoreSchedulerInputDto = {
        }
        $scope.remove = function (entity) {
            //alert("remote " + JSON.stringify(entity));
            DeleteadminStoreSchedulerInputDto.id = entity.id;
                ...
                buttons: {
                    Yes: {
                        ...
                        action: function (scope, button) {
                            _thisServicesadminStoreScheduler.delete(DeleteadminStoreSchedulerInputDto).then(function (result) {
        ...
        //    _thisServicesadminStoreScheduler.exportToCSV().then(function (result) {
        ...
        $scope.DropValueChange = function (item) {
            ...
            if (item === 'Export CSV') {
                ...
                var modalInstance = $uibModal.open({
                    templateUrl: '/App/Main/views/adminStoreScheduler/importModal.cshtml',
                    controller: 'importadminStoreSchedulerCTR',
                    backdrop: 'static'
                });
        ...
        //ui-Grid Call
        $scope.GetadminStoreScheduler = function () {
            ...
            $scope.gridOptions = {
                ...
                columnDefs: [
                    ...
                    { name: "storeName", title: "Store Name", width: '30%', headerCellClass: $scope.highlightFilteredHeader },
                    { name: "startDate", title: "Start Date", width: '20%', headerCellClass: $scope.highlightFilteredHeader },
                    { name: "endDate", title: "End Date", width: '20%', headerCellClass: $scope.highlightFilteredHeader },
                    { name: "status", title: "Status", width: '20%', headerCellClass: $scope.highlightFilteredHeader },
            ...
            //var apiRoute = 'api/adminStoreScheduler/GetadminStoreScheduler/' + NextPage + '/' + NextPageSize;
            //var result = CRUDService.getadminStoreScheduler(apiRoute);
            ...
            _thisServicesadminStoreScheduler.getAdvanceSearch($scope.SearchDto).then(function (result) {
                if (result.data === null) {
