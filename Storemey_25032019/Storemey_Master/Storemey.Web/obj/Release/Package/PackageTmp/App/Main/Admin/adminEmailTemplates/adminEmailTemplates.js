        ...
        $scope.GetadminEmailTemplates = function () {
            ...
            $scope.gridOptions = {
                ...
                columnDefs: [
                    ...
                    { name: "bCCEmail", title: "BCC Email", width: '20%', headerCellClass: $scope.highlightFilteredHeader },
                    { name: "emailKey", title: "EmailKey", width: '20%', headerCellClass: $scope.highlightFilteredHeader },
                    { name: "subject", title: "Subject", width: '20%', headerCellClass: $scope.highlightFilteredHeader },
                    {
                        name: 'Commands',
                        enableFiltering: false,
                        enableSorting: false,
