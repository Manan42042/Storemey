...
app.constant('JS_REQUIRES', {
    ...
    modules: [{
        ...
        name: 'chart.js',
            files: ['/Content/StoremeyTheme/ANGULARJS/bower_components/angular-chart.js/dist/angular-chart.min.js', '..//bower_components/angular-chart.js/dist/angular-chart.min.css']
    }, {
        name: 'flow',
