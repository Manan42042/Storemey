...
namespace Storemey.StoreSalePayments
{
    public class StoreSalePaymentsManager : IStoreSalePaymentsManager
    {
        ...
        public async Task<IQueryable<StoreSalePayments>> ListAllQueryable(string SearchText, int CurrentPage, int MaxRecords, string SortColumn, string SortDirection)
        {
            try
            {
