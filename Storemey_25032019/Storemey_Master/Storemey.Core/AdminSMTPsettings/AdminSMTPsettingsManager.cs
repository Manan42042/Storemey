...
{
    public class AdminSMTPsettingsManager : IAdminSMTPsettingsManager
    {
        private readonly IRepository<AdminSMTPsettings, Guid> _thisManagerRpository;
        private readonly IUnitOfWorkManager _unitOfWorkManager;

        public AdminSMTPsettingsManager(
            IRepository<AdminSMTPsettings, Guid> myMasterRepository,
        ...
        public async Task<IEnumerable<AdminSMTPsettings>> ListAll()
        {
        ...
        public async Task<IQueryable<AdminSMTPsettings>> ListAllQueryable(string SearchText, int CurrentPage, int MaxRecords, string SortColumn, string SortDirection)
        {
            try
            {
                    ...
                    case "desc":
                        ...
                        switch (SortColumn)
                        {
                            case "id":
                                ...
                                break;
                            case "host":
                                @MasterCountries = @MasterCountries.OrderByDescending(x => x.Host);
                                break;
                    ...
                    default:
                        switch (SortColumn)
                        {
                            case "id":
                                ...
                                break;
                            case "host":
                                @MasterCountries = @MasterCountries.OrderBy(x => x.Host);
                                break;
        ...
        public async Task Create(AdminSMTPsettings input)
        {
        ...
        public async Task Update(AdminSMTPsettings input)
        {
            input.IsDeleted = false;
        ...
        public async Task Delete(AdminSMTPsettings input)
        {
        ...
        public async Task CreateOrUpdate(AdminSMTPsettings input)
        {
