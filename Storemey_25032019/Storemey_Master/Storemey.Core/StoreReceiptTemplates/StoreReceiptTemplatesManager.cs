...
namespace Storemey.StoreReceiptTemplates
{
    public class StoreReceiptTemplatesManager : IStoreReceiptTemplatesManager
    {
        ...
        public async Task<IQueryable<StoreReceiptTemplates>> ListAllQueryable(string SearchText, int CurrentPage, int MaxRecords, string SortColumn, string SortDirection)
        {
            try
            {
