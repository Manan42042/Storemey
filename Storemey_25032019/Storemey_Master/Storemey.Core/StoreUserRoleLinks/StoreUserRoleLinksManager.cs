...
namespace Storemey.StoreUserRoleLinks
{
    public class StoreUserRoleLinksManager : IStoreUserRoleLinksManager
    {
        ...
        public async Task<IQueryable<StoreUserRoleLinks>> ListAllQueryable(string SearchText, int CurrentPage, int MaxRecords, string SortColumn, string SortDirection)
        {
            try
            {
