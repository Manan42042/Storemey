...
namespace Storemey.StoreProductSeasonLinks
{
    public class StoreProductSeasonLinksManager : IStoreProductSeasonLinksManager
    {
        ...
        public async Task<IQueryable<StoreProductSeasonLinks>> ListAllQueryable(string SearchText, int CurrentPage, int MaxRecords, string SortColumn, string SortDirection)
        {
            try
            {
