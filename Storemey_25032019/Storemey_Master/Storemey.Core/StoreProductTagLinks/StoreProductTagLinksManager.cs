...
namespace Storemey.StoreProductTagLinks
{
    public class StoreProductTagLinksManager : IStoreProductTagLinksManager
    {
        ...
        public async Task<IQueryable<StoreProductTagLinks>> ListAllQueryable(string SearchText, int CurrentPage, int MaxRecords, string SortColumn, string SortDirection)
        {
            try
            {
