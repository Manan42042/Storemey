...
namespace Storemey.StoreSaleTransactions
{
    public class StoreSaleTransactionsManager : IStoreSaleTransactionsManager
    {
        ...
        public async Task<IQueryable<StoreSaleTransactions>> ListAllQueryable(string SearchText, int CurrentPage, int MaxRecords, string SortColumn, string SortDirection)
        {
            try
            {
