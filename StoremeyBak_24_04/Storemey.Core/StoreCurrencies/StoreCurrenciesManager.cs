...
namespace Storemey.StoreCurrencies
{
    public class StoreCurrenciesManager : IStoreCurrenciesManager
    {
        ...
        public async Task<Tuple<IQueryable<StoreCurrencies>, int>> ListAllQueryable(string SearchText, int CurrentPage, int MaxRecords, string SortColumn, string SortDirection)
