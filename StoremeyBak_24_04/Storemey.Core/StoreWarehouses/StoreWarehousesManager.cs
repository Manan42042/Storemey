...
namespace Storemey.StoreWarehouses
{
    public class StoreWarehousesManager : IStoreWarehousesManager
    {
        ...
        public async Task<Tuple<IQueryable<StoreWarehouses>,int>> ListAllQueryable(string SearchText, int CurrentPage, int MaxRecords, string SortColumn, string SortDirection)
        {
            try
            {
                int recordCount = 0;
