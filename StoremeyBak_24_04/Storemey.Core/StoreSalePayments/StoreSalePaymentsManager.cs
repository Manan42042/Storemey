...
using Storemey.StoreSalePayments;
using Storemey.Authorization.Users;
using System.Data.Entity.SqlServer;

namespace Storemey.StoreSalePayments
{
    public class StoreSalePaymentsManager : IStoreSalePaymentsManager
    {
        private readonly IRepository<StoreSalePayments, Guid> _thisRpository;
        private readonly IUnitOfWorkManager _unitOfWorkManager;
        private readonly UserRegistrationManager _userRegistrationManager;

        public StoreSalePaymentsManager(
            IRepository<StoreSalePayments, Guid> myMasterRepository,
        ...
        public async Task<IEnumerable<StoreSalePayments>> ListAll()
        {
            try
            {
        ...
        public async Task<Tuple<IQueryable<StoreSalePayments>, int>> ListAllQueryable(string SearchText, int CurrentPage, int MaxRecords, string SortColumn, string SortDirection)
        {
            try
            {
                int recordCount = 0;
        ...
        public async Task Create(StoreSalePayments input)
        {
            try
            {
