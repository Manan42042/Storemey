...
namespace Storemey.StoreGeneralSettings
{
    public class StoreGeneralSettingsManager : IStoreGeneralSettingsManager
    {
        ...
        public async Task<Tuple<IQueryable<StoreGeneralSettings>, int>> ListAllQueryable(string SearchText, int CurrentPage, int MaxRecords, string SortColumn, string SortDirection)
