...
namespace Storemey.StoreTax
{
    public class StoreTaxManager : IStoreTaxManager
    {
        ...
        public async Task<Tuple<IQueryable<StoreTax>,int>> ListAllQueryable(string SearchText, int CurrentPage, int MaxRecords, string SortColumn, string SortDirection)
        {
            try
            {
                int recordCount = 0;
