...
Framework7.utils.i18n = {
	...
	setLanguage: function(language) {
		...
		i18next.changeLanguage(language.lang, function() {
			...
			if (language.dir == 'rtl') {
                app.$('.f7[rel=stylesheet]').attr('href', '/Mobile/www/assets/vendor/framework7/css/framework7.rtl.min.css');
				app.params.rtl = true;
			}
			else {
                app.$('.f7[rel=stylesheet]').attr('href', '/Mobile/www/assets/vendor/framework7/css/framework7.min.css');
