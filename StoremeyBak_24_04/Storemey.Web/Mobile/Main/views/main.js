...
function ($rootScope, $state, $stateParams) {
    ...
    $rootScope.app = {
        ...
        defaultLayout: {
            ...
            isBoxedPage: true, // true if you want to initialize the template with boxed layout
            theme: 'lyt1-theme-1', // indicate the theme chosen for your project
            logo: '/assets/images/logo.png', // relative path of the project logo
            logoCollapsed: 'favicon.png' // relative path of the collapsed logo
        },
        layout: ''
    };
...
angular.module('app').config(['$localStorageProvider',
