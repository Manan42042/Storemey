...
namespace Storemey.Web.Controllers
{
    ...
    public class HomeController : StoremeyControllerBase
    {
        ...
        {
            return View("~/Mobile/www/index.cshtml"); //Layout of the angular application.
            //return View("~/Mobile/Main/views/layout/layout.cshtml"); //Layout of the angular application.
        }
