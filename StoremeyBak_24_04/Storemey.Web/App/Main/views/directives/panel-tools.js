 ...
 */
angular.module('app').directive('ctPaneltool', function () {
    var templates = {
...
angular.module('app').directive('panelExpand', function ($compile) {
    'use strict';
    return {
        restrict: 'A',
        replace: false,
...
angular.module('app').directive('panelRefresh', function () {
    'use strict';
...
angular.module('app').directive('panelDismiss', function () {
    'use strict';
    return {
        restrict: 'A',
        controller: ["$scope", "$element",
