...
app.controller('storeBrandssCtrl', ['$scope', '$ngConfirm', '$state', '$stateParams', '$uibModal', 'abp.services.app.storeBrands','cfpLoadingBar', 
    function ($scope, $ngConfirm, $state, $stateParams, $uibModal, _thisServicesstoreBrandss, cfpLoadingBar) {
        $scope.gridOptions = [];
        $scope.storeBrandss = [];
        ...
        $scope.edit = function (entity) {
            ...
            //$state.go('addeditstoreBrands', { 'id': entity.id, 'searchDto': $scope.SearchDto });
            $scope.SearchDto.tempID = entity.id;
            $state.go('addeditstoreBrands', { SearchDto: $scope.SearchDto });
        }

        var DeletestoreBrandsInputDto = {
        }
        $scope.remove = function (entity) {
            //alert("remote " + JSON.stringify(entity));
            DeletestoreBrandsInputDto.id = entity.id;
                ...
                buttons: {
                    Yes: {
                        ...
                        action: function (scope, button) {
                            _thisServicesstoreBrandss.delete(DeletestoreBrandsInputDto).then(function (result) {
        ...
        //    _thisServicesstoreBrandss.exportToCSV().then(function (result) {
        ...
        $scope.DropValueChange = function (item) {
            ...
            if (item === 'Export CSV') {
                ...
                var modalInstance = $uibModal.open({
                    templateUrl: '/App/Main/views/storeBrands/importModal.cshtml',
                    controller: 'importstoreBrandsCTR',
                    backdrop: 'static'
                });
        ...
        //ui-Grid Call
        $scope.GetstoreBrandss = function () {
            ...
            $scope.gridOptions = {
                ...
                columnDefs: [
                    ...
                    { name: "brandName", displayName: "Brand Name", width: '30%', headerCellClass: $scope.highlightFilteredHeader },
            ...
            //var apiRoute = 'api/storeBrands/GetstoreBrandss/' + NextPage + '/' + NextPageSize;
            //var result = CRUDService.getstoreBrandss(apiRoute);
            ...
            cfpLoadingBar.start();
                ...
                _thisServicesstoreBrandss.getAdvanceSearch($scope.SearchDto).then(function (result) {
                    if (result.data === null) {
