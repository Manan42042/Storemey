(function () {
    angular.module('app').controller('app.views.storeWarehouses', [
        ...
        function ($scope, $state, $stateParams, _thisServices, _masterService) {
            ...
            $scope.$watch("GetstoreWarehousesOutputDto.uicountryId", function (newValue, oldValue) {
                    ...
                    _masterService.listAllStates(newValue.id)
                        .then(function (result) {
                            ...
                            if (result3[0] !== undefined) {
                                ...
                                $scope.GetstoreWarehousesOutputDto.uistateId = result3[0];
                            }
            ...
            $scope.$watch("GetstoreWarehousesOutputDto.uistateId", function (newValue, oldValue) {
                ...
                if (newValue !== undefined && newValue !== "" && newValue !== 0) {
                    ...
                    _masterService.listAllCities(newValue.id)
                        .then(function (result) {
                            ...
                            if (result3[0] !== undefined) {
                                console.log(result3[0]);
                                $scope.GetstoreWarehousesOutputDto.uicityId = result3[0];
                            }
                ...
                _thisServices.getById(GetstoreWarehousesInputDto)
                    .then(function (result) {
                        ...
                        if (result2[0] !== undefined) {
                            ...
                            $scope.GetstoreWarehousesOutputDto.uicountryId = result2[0];
                        }
                    });
            }
            ...
            $scope.saveAddEdit = function () {
                ...
                $scope.GetstoreWarehousesOutputDto.country = $scope.GetstoreWarehousesOutputDto.uicountryId.countryName;
                $scope.GetstoreWarehousesOutputDto.countryId = $scope.GetstoreWarehousesOutputDto.uicountryId.id;
                $scope.GetstoreWarehousesOutputDto.state = $scope.GetstoreWarehousesOutputDto.uistateId.stateName;
                $scope.GetstoreWarehousesOutputDto.stateId = $scope.GetstoreWarehousesOutputDto.uistateId.id;
                $scope.GetstoreWarehousesOutputDto.city = $scope.GetstoreWarehousesOutputDto.uicityId.cityName;
                $scope.GetstoreWarehousesOutputDto.cityId = $scope.GetstoreWarehousesOutputDto.uicityId.id;
