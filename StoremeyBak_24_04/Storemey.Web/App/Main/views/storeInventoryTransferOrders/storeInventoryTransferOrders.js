...
app.controller('storeInventoryTransferOrderssCtrl', ['$scope', '$ngConfirm', '$state', '$stateParams', '$uibModal', 'abp.services.app.storeInventoryTransferOrders','cfpLoadingBar', 
    function ($scope, $ngConfirm, $state, $stateParams, $uibModal, _thisServicesstoreInventoryTransferOrderss, cfpLoadingBar) {
        $scope.gridOptions = [];
        $scope.storeInventoryTransferOrderss = [];
        ...
        $scope.edit = function (entity) {
            ...
            //$state.go('addeditstoreInventoryTransferOrders', { 'id': entity.id, 'searchDto': $scope.SearchDto });
            $scope.SearchDto.tempID = entity.id;
            $state.go('addeditstoreInventoryTransferOrders', { SearchDto: $scope.SearchDto });
        }

        var DeletestoreInventoryTransferOrdersInputDto = {
        }
        $scope.remove = function (entity) {
            //alert("remote " + JSON.stringify(entity));
            DeletestoreInventoryTransferOrdersInputDto.id = entity.id;
                ...
                buttons: {
                    Yes: {
                        ...
                        action: function (scope, button) {
                            _thisServicesstoreInventoryTransferOrderss.delete(DeletestoreInventoryTransferOrdersInputDto).then(function (result) {
        ...
        //    _thisServicesstoreInventoryTransferOrderss.exportToCSV().then(function (result) {
        ...
        $scope.DropValueChange = function (item) {
            ...
            if (item === 'Export CSV') {
                ...
                var modalInstance = $uibModal.open({
                    templateUrl: '/App/Main/views/storeInventoryTransferOrders/importModal.cshtml',
                    controller: 'importstoreInventoryTransferOrdersCTR',
                    backdrop: 'static'
                });
        ...
        $scope.pagination = {
            ...
            pageSizeChange: function () {
                ...
                this.pageNumber = 1;
                $scope.GetstoreInventoryTransferOrderss();
            },
            firstPage: function () {
        ...
        //ui-Grid Call
        $scope.GetstoreInventoryTransferOrderss = function () {
            ...
            //var apiRoute = 'api/storeInventoryTransferOrders/GetstoreInventoryTransferOrderss/' + NextPage + '/' + NextPageSize;
            //var result = CRUDService.getstoreInventoryTransferOrderss(apiRoute);
            ...
            cfpLoadingBar.start();
                ...
                _thisServicesstoreInventoryTransferOrderss.getAdvanceSearch($scope.SearchDto).then(function (result) {
                    if (result.data === null) {
