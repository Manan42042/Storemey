...
app.controller('storeInventorysCtrl', ['$scope', '$ngConfirm', '$state', '$stateParams', '$uibModal', 'abp.services.app.storeInventory','cfpLoadingBar', 
    function ($scope, $ngConfirm, $state, $stateParams, $uibModal, _thisServicesstoreInventorys, cfpLoadingBar) {
        $scope.gridOptions = [];
        $scope.storeInventorys = [];
        ...
        $scope.edit = function (entity) {
            ...
            //$state.go('addeditstoreInventory', { 'id': entity.id, 'searchDto': $scope.SearchDto });
            $scope.SearchDto.tempID = entity.id;
            $state.go('addeditstoreInventory', { SearchDto: $scope.SearchDto });
        }

        var DeletestoreInventoryInputDto = {
        }
        $scope.remove = function (entity) {
            //alert("remote " + JSON.stringify(entity));
            DeletestoreInventoryInputDto.id = entity.id;
                ...
                buttons: {
                    Yes: {
                        ...
                        action: function (scope, button) {
                            _thisServicesstoreInventorys.delete(DeletestoreInventoryInputDto).then(function (result) {
        ...
        //    _thisServicesstoreInventorys.exportToCSV().then(function (result) {
        ...
        $scope.DropValueChange = function (item) {
            ...
            if (item === 'Export CSV') {
                ...
                var modalInstance = $uibModal.open({
                    templateUrl: '/App/Main/views/storeInventory/importModal.cshtml',
                    controller: 'importstoreInventoryCTR',
                    backdrop: 'static'
                });
        ...
        //ui-Grid Call
        $scope.GetstoreInventorys = function () {
            ...
            //var apiRoute = 'api/storeInventory/GetstoreInventorys/' + NextPage + '/' + NextPageSize;
            //var result = CRUDService.getstoreInventorys(apiRoute);
            ...
            cfpLoadingBar.start();
                ...
                _thisServicesstoreInventorys.getAdvanceSearch($scope.SearchDto).then(function (result) {
                    if (result.data === null) {
