...
using net.authorize.StoremeyPayments;
using System.IO;
...
namespace StoremeyPaymentsCodeTest
{
    [TestFixture]
    public class TestRunner
    {
        ...
        [Test]
        public void TestAllStoremeyPaymentsCodes()
        {
        ...
        {
            string namespaceString = "net.authorize.StoremeyPayments.";
            ...
            Type classType = null;
#if NETCOREAPP2_0
            classType = Type.GetType(namespaceString + className + ",StoremeyPaymentsCode_DotNet_Core");
#else
               classType = Type.GetType(namespaceString + className + ",StoremeyPaymentsCode");
#endif
